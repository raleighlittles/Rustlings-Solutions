...
/* Hint: When you're thinking about what changes to make in the tests, remember that these exercises have to do with Iterators. */
...
pub fn divide(a: i32, b: i32) -> Result<i32, DivisionError> {
    if b == 0 {
        ...
        // Note: I really don't like this syntax.
